...
function Kindergarten() {
    return (
        <Main>
          ...
          <img src='https://drive.google.com/uc?id=1IyZhZBV-ZeoIDFUacLw5nY4hgsHtB5yI' style={{height:'400px',width:'350px',display:'flex',margin:'auto',border:'1px solid grey',padding:'10px'}} alt="" />
          <img src='https://drive.google.com/uc?id=13HNH1gjvAnlYDHBdH5HHCMQ_SlmyGs-2' style={{height:'400px',width:'350px',display:'flex',margin:'auto',border:'1px solid grey',padding:'10px'}} alt="" />
