    ...
    return (
        <Main>
           ...
           <Rowcolumn33>
              ...
              <Link to='/principal'  style={{textDecoration:'none'}}>  <Teampeople image='https://drive.google.com/uc?id=1JwOzN2PCb6Yx0ohKj1v_-aGQCHl0dEjR' name='Dyuti Sardesai' designation='Principal'/></Link>
