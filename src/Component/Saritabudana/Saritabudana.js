...
function Strongfoundation() {
    return (
        <Main>
            ...
            <hr />
            <img src='https://scontent-bom1-1.xx.fbcdn.net/v/t1.6435-9/243075101_591764492177628_5951892245893792836_n.jpg?_nc_cat=106&ccb=1-5&_nc_sid=730e14&_nc_ohc=n5lH0VkpGpYAX97QSIm&_nc_ht=scontent-bom1-1.xx&oh=852b61b57eaef19413c47ab5daf859ce&oe=617804E4' style={{height:'400px',width:'40vw',display:'flex',margin:'auto',border:'1px solid grey',padding:'10px'}} alt="" />
