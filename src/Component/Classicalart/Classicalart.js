...
function Classrooms() {
    return (
        <Main>
            ...
            <hr />
            <img src='https://icecube-eu-403.icedrive.io/download?p=03MgP6WfyoV7ravJLXXPQpJPxfxWaLNK.om0e1LyOb4fmYKRj794R._HoTwoibzPS1KUcsCHoCyytXLQKpnxn87bX0JZ3ScffVFeredcu9i3i47XSbcPusTlSJEME.QTnQcnOGsc7B5zsOjBLUpl9rOCSXCFBzPzE6E2Jl3Cby5Mz7CFh0dcV6LYNPHUzUib.ob7qPlNUbDk0fMpHt7kvRYY4Ttp0ffPnBPjGjWoZlI5Pj0jXnuZ3Svt5zfpEcbd' style={{height:'400px',width:'67vw',display:'flex',margin:'auto',border:'1px solid grey',padding:'10px'}} alt="" />
