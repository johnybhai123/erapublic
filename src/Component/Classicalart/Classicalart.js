...
function Classrooms() {
    return (
        <Main>
            ...
            <hr />
            <img src='https://drive.google.com/uc?id=1SC0rzkXFApexHwh_fKQVwPrZ4POx0Vwf' style={{height:'400px',width:'67vw',display:'flex',margin:'auto',border:'1px solid grey',padding:'10px'}} alt="" />
