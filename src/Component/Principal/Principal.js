...
function Principal() {
    return (
        <Main>
            ...
            <hr />
            <img src='https://scontent.fbho4-2.fna.fbcdn.net/v/t1.6435-9/243086802_591764482177629_5986111960242541710_n.jpg?_nc_cat=107&ccb=1-5&_nc_sid=730e14&_nc_ohc=XhOcx2rbE1MAX97zQrC&_nc_ht=scontent.fbho4-2.fna&oh=371cdd88ae91ba5024fb63711071ea60&oe=61770040' style={{height:'400px',width:'40vw',display:'flex',margin:'auto',border:'1px solid grey',padding:'10px'}} alt="" />
